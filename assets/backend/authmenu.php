<?php 
    ...
    $username = $my_data['firstname']. ' ' .$my_data['lastname'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="flex-grow">
            ...
            <?php
                if ($my_data['user_level'] == 'admin') {
                    ?>
                        <div class="w-full">
                            <a href="manageJobs.php" class="">
                                <div class="py-4 px-3 w-full hover:bg-white hover:text-blue-300 <?php if($title == 'Manage Jobs'){ echo 'border-r-4 border-blue-400 bg-blue-200 text-white';}?>">
                                    <i class="fa fa-tachometer-alt text-xs"></i> Manage Jobs
                                </div>
                            </a>
                        </div>
                        <div class="w-full">
                            <a href="manageStaff.php" class="">
                                <div class="py-4 px-3 w-full hover:bg-white hover:text-blue-300 <?php if($title == 'Manage Staffs'){ echo 'border-r-4 border-blue-400 bg-blue-200 text-white';}?>">
                                    <i class="fa fa-tachometer-alt text-xs"></i> Manage Staffs
                                </div>
                            </a>
                        </div>
                    <?php
