<div class="fixed px-3 topNav bg-white bg-opacity-0 text-white right-0 w-screen z-40">
        ...
        <div class="flex w-full flex-col md:flex-row px-3">
            ...
            <div id="togglerElement" class="md:pr-6 py-5 flex-col md:flex-row md:py-0 gap-12 hidden bg-white md:bg-transparent md:flex">
                <div class="flex flex-col items-center md:flex-row gap-8 capitalize ">
                    <a href="../jobSeeker/#welcome" class="cursor-pointer">welcome</a>
                    <a href="../jobSeeker/#about" class="cursor-pointer">about us</a>
                    <a href="../jobSeeker/#recent" class="cursor-pointer">vacancy</a>
